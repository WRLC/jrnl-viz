...
d <- read_csv(params$file) %>%
  mutate(programs_with_holdings = ifelse(programs_with_holdings == 1, "1", 
                                     ifelse(programs_with_holdings == 2, "2", "More than 2"))) %>%
  mutate(locations_with_holdings = ifelse(locations_with_holdings == 1, "1",
                                     ifelse(locations_with_holdings == 2, "2", "More than 2"))) %>%
  left_join(wc_have) %>%
...
renderValueBox({
  ...
  valueBox(
    ...
    icon = "fa-university",
    color = "#076293",
    caption = "Total number of title commitments in JRNL"
  )
...
renderValueBox({
  ...
  valueBox(
    ...
    icon = "fa-book",
    color = "#e89c51",
    caption = "Number of commitments that match your filtering criteria"
  )
...
renderValueBox({
  ...
  tmp <- values$df %>%
    filter(programs_with_holdings == "1")
  
  valueBox(
    value = paste0(format(nrow(tmp), big.mark = ",", scientific = FALSE)),
    icon = "fa-ban",
    color = "#9d162e",
    caption = "Title records committed by a single program"
  )
...
renderValueBox({
  ...
  tmp <- values$df %>%
    filter(programs_with_holdings == "More than 2")
  
  valueBox(
    value = paste0(format(nrow(tmp), big.mark = ",", scientific = FALSE)),
    icon = "fa-thumbs-up",
    color = "#62d15b",
    caption = "Title records committed by 3 or more programs"
  )
...
renderValueBox({
  ...
  tmp <- values$df %>%
    filter(locations_with_holdings == "1")
  
  valueBox(
    value = paste0(format(nrow(tmp), big.mark = ",", scientific = FALSE)),
    icon = "fa-ban",
    color = "#9d162e",
    caption = "Title records committed by a single location"
  )
...
renderValueBox({
  ...
  tmp <- values$df %>%
    filter(locations_with_holdings == "More than 2")
  
  valueBox(
    value = paste0(format(nrow(tmp), big.mark = ",", scientific = FALSE)),
    icon = "fa-thumbs-up",
    color = "#62d15b",
    caption = "Title records committed by 3 or more locations"
  )
...
renderValueBox({
  ...
  valueBox(
    ...
    icon = "fa-ban",
    color = "#9d162e",
    caption = "Percent of title records committed by a single program"
  )
...
renderValueBox({
  ...
  tmp <- values$df %>%
    filter(programs_with_holdings == "2" | programs_with_holdings == "More than 2")
  
  valueBox(
    value = paste0(round(nrow(tmp)/nrow(values$df) * 100, 2), "%"),
    icon = "fa-thumbs-up",
    color = "#62d15b",
    caption = "Percent of title records committed by 3 or more programs"
  )
...
renderValueBox({
  ...
  valueBox(
    ...
    icon = "fa-ban",
    color = "#9d162e",
    caption = "Percent of title records committed by a single location"
  )
...
renderValueBox({
  ...
  valueBox(
    ...
    icon = "fa-thumbs-up",
    color = "#62d15b",
    caption = "Percent of title records committed by three or more locations"
  )
...
observeEvent(input$get_wc, {
  ...
  if(ws_key_exists) {
    ...
    if(nrow(values$df) <= 10000) {
      ...
      # Don't run with more than 10000 records in a request
      showModal(
        modalDialog(
          title = NULL,
          HTML("Please adjust your filters to retrieve 10000 or fewer records.</br></br>
